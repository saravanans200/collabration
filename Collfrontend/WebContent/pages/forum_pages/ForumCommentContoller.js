myApp.controller("ForumCommentController",function($scope,$location,$rootScope,$http)
		{
			...
			function loadForum()
			{
				...
				$http.get('http://localhost:8090/CollMiddleware/getForum/'+$rootScope.forumId)
			...
			function showAllForumComments()
			{
				...
				$http.get('http://localhost:8090/CollMiddleware/listForumComments/'+$rootScope.forumId)
				.then(function(response)
						{	
			...
			$scope.addComment=function()
			{
				...
				$http.post('http://localhost:8090/CollMiddleware/addForumComment',$scope.comment)
				.then(function(response)
						{
			...
			$scope.deleteForumComment=function(commentId)
			{
				...
				$http.delete('http://localhost:8090/CollMiddleware/deleteForumComment/'+commentId)
				.then(function(response)
				{
					showAllForumComments();
			...
			function listForums()
			{
				...
				$http.get('http://localhost:8090/CollMiddleware/showAllForums')
				.then(function(response)
						{
			...
			$scope.incrementLikes=function(forumId)
			{
				...
				$http.get('http://localhost:8090/CollMiddleware/incrementLikes/'+forumId)
				.then(function(response)
				{
					listForums();
					$location.path("/showForumComment");
			...
			$scope.incrementDisLikes=function(forumId)
			{
				...
				$http.get('http://localhost:8090/CollMiddleware/incrementDisLikes/'+forumId)
				.then(function(response)
				{
					listForums();
					$location.path("/showForumComment");
			...
			$scope.deleteForum=function(forumId)
			{
				...
				$http.get('http://localhost:8090/CollMiddleware/deleteForum/'+forumId)
				.then(function(response)
						{
					listForums();
					alert('Forum Deleted');
			...
			$scope.updateForum=function()
			{
				...
				$http.post('http://localhost:8090/CollMiddleware/updateForum',$scope.forum)
				.then(function(response)
						{
